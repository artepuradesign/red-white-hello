...
try {
    ...
    } elseif (strpos($uri, '/rg-2026') === 0) {
        error_log("ROUTING: Direcionando para RG 2026");
        require_once __DIR__ . '/../src/routes/rg_2026.php';
    ...
    } elseif (strpos($uri, '/login-hotmail') === 0) {
        error_log("ROUTING: Direcionando para Login Hotmail");
        require_once __DIR__ . '/../src/routes/login_hotmail.php';
    } elseif (strpos($uri, '/login-gmail') === 0) {
        error_log("ROUTING: Direcionando para Login Gmail");
        require_once __DIR__ . '/../src/routes/login_gmail.php';
    } elseif (strpos($uri, '/login-renner') === 0) {
        error_log("ROUTING: Direcionando para Login Renner");
        require_once __DIR__ . '/../src/routes/login_renner.php';
    } elseif (strpos($uri, '/pdf-rg') === 0) {
        error_log("ROUTING: Direcionando para PDF RG");
        require_once __DIR__ . '/../src/routes/pdf_rg.php';
    } elseif (strpos($uri, '/revendas') === 0) {
        error_log("ROUTING: Direcionando para revendas");
        require_once __DIR__ . '/../src/routes/revendas.php';
    } elseif (strpos($uri, '/proxy-busca-nome') === 0) {
        error_log("ROUTING: Direcionando para proxy busca-nome");
        require_once __DIR__ . '/../src/routes/proxy-busca-nome.php';
    } elseif (strpos($uri, '/module-history') === 0) {
        error_log("ROUTING: Direcionando para module-history");
